...
def atualizar_status_pedido(pedido_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"message": "Status atualizado com sucesso", "pedido": pedido_dict}
            ),
            200,
        )
    except Exception as e:
...
def obter_pedido_ativo_cliente(cliente_id):
    ...
    """
    try:
        pedido = Pedido.query.filter_by(cliente_id=cliente_id, fechado=False).first()
...
def fechar_pedido(pedido_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"message": "Pedido fechado com sucesso", "pedido": pedido.to_dict()}
            ),
            200,
        )
